...
<body>
  <div class="sidebar close" style="opacity: 1; ">
    <div class="logo-details">
      ...
      <a href="?url=/"><i class="fa-solid fa-droplet"></i></a>
    ...
    <ul class="nav-links">
      <li>
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="?url=/">Trang chủ</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
          <a href="?url=listPosition">
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="?url=listPosition"> Chức vụ</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="?url=listDepartment">Phòng ban</a></li>
          <li><a href="?url=listDepartment" >Danh sách</a></li>
          <li><a href="?url=addDepartment">Thêm mới</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="?url=listStaff">Nhân viên</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="?url=listTimekeeping">Chấm công</a></li>
