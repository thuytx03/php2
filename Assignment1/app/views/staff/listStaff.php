    ...
    <h1 class="mt-2">Danh sách nhân viên</h1>
    <p>
        ...
        <tbody>
            <?php foreach ( $all as $key => $value) : ?>
                <tr>
                    ...
                    <td><?= $value['cmnd'] ?></td>
                    <td>
                        <a href="?url=deleteStaff&id=<?= $value['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xoá Nhân Viên <?= $value['full_name'] ?> ? Hành động này có thể xoá toàn bộ dữ liệu về Nhân Viên này !' )" title="Delete" class="btn btn-danger">Xoá</a>
