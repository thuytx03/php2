  ...
  <div class="container">
    ...
    <form action="?url=addStaff" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <label for="my-input">Chức vụ:</label>
          ...
          <?php if(isset($error_position)) : ?>
                    <span class='error text-danger mt-2 fw-bold'><?= $error_position ?></span>
                <?php endif ?>
      </div>
      <div class="form-group">
        <label for="my-input">Phòng ban:</label>
          ...
          <?php if(isset($error_department)) : ?>
                    <span class='error text-danger mt-2 fw-bold'><?= $error_department ?></span>
                <?php endif ?>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" name="numberphone" class="form-control" placeholder="Vui lòng nhập số điện thoại">
        <?php if(isset($error_numberphone)) : ?>
                    <span class='error text-danger mt-2 fw-bold'><?= $error_numberphone ?></span>
                <?php endif ?>
      </div>
      <div class="form-group">
        <label>Số CMND || CCCD:</label>
        <input type="text" name="cmnd" class="form-control" placeholder="Vui lòng nhập số CMND || CCCD">
        <?php if(isset($error_cmnd)) : ?>
                    <span class='error text-danger mt-2 fw-bold'><?= $error_cmnd ?></span>
                <?php endif ?>
      </div>
      <div class="form-group">
        <label>Địa chỉ:</label>
      ...
      <div class="form-group">
        ...
        <?php if(isset($error_birthday)) : ?>
                    <span class='error text-danger mt-2 fw-bold'><?= $error_birthday ?></span>
                <?php endif ?>
      </div>
      <div class="form-group">
